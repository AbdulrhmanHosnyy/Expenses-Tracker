...
{
    public partial class AddAndEditCustomerForm : Form
    {
        //  Variables
        ...
        public AddAndEditCustomerForm(int id, CustomerUserControl customerUserControl)
        {
            InitializeComponent();
        ...
        private async void AddAndEditCustomerForm_Load(object sender, EventArgs e)
        {
            //  Set Field
            loadingForm.Show();
            SetFieldData();
        ...
        private async Task<bool> AddData()
        {
            ...
            else
            {
                ...
                {
                    Title = "Add Customer Operation",
                        Username = Properties.Settings.Default.UserName,
                    Details = "New Customer is added: " + customer.Name,
                    AddedDate = DateTime.Now,
                };
        ...
        private async Task<bool> EditData()
        {
            ...
            else
            {
                ...
                SystemRecord systemRecord = new SystemRecord
                {
                    Title = "Edit Customer Operation",
                    Username = Properties.Settings.Default.UserName,
                    Details = "Customer is Edited: " + customer.Name,
                    AddedDate = DateTime.Now,
                };
                await dataHelperSystemRecord.AddAsync(systemRecord);
                customerUserControl.LoadData();
