...
namespace ExpensesTracker.GUI.IncomeGUI
{
    public partial class IncomeUserControl : UserControl
    {
        ...
        private static IncomeUserControl incomeUserControl;
        ...
        {
            AddAndEditIncomeForm addAndEditIncomeForm = new AddAndEditIncomeForm(0, ProjectId, this);
                        ...
                        for (int i = 0; i < IdList.Count; i++)
                        {
                            ...
                            if (result == 1)
                            {
                                ...
                                SystemRecord systemRecord = new SystemRecord
                                {
                                    ...
                                    Details = "Income with id " + RowId.ToString() + "is deleted",
        ...
        private DataTable SetDataTableColumns(DataTable dataTable)
        {
            ...
            dataTable.Columns["SupplierName"].ColumnName = "CustomerName";
            dataTable.Columns["IncomeDate"].SetOrdinal(3);
            dataTable.Columns["IncomeDate"].ColumnName = "IncomeDate";
        ...
        private void SetColumnsTitles()
        {
            ...
            dataGridView1.Columns[3].HeaderText = "IncomeDate";
        ...
        private void Edit()
        {
            if (dataGridView1.RowCount > 0)
            {
                ...
                AddAndEditIncomeForm addAndEditIncomeForm =
                    new AddAndEditIncomeForm(RowId, ProjectId, this);
                addAndEditIncomeForm.Show();
            }
            else
            {
